...
export const widgetBorder = registerColor('widget.border', { dark: '#ffffff17', light: transparent(Color.black, .16), hcDark: null, hcLight: null }, nls.localize('widgetShadow', 'Shadow color of widgets such as find/replace inside the editor.'));
